...
public class BSpline extends Applet implements ActionListener, MouseWheelListener {
  ...
  public void init() {
    Color buttonColor1 = new Color(255, 255, 255);
    Color buttonColor2 = new Color(255, 255, 255);
  ...
  public void paint(Graphics g) {
    ...
    // Draw control points
    plotpoint(g, -40, -10, Color.RED);
    plotpoint(g, -20, 20, Color.RED);
    plotpoint(g, 0, 25, Color.RED);
    plotpoint(g, 20, 10, Color.RED);
    
    plotpoint(g, 20, -10, Color.RED);
    plotpoint(g, 40, -40, Color.RED);
    plotpoint(g, 80, -40, Color.RED);
    plotpoint(g, 60, 10, Color.RED);
  }
}