...
public class shapes extends Canvas {
	...
	static int originX, originY, offx = 0, offy = 0, grid = 500, block = 10;
	static int parent1[] = { 0, 0, 0, 0, 0, 0, 0, 2, 0 };
	...
	public void plotellipse(Graphics g, int rx, int ry, int xc, int yc, int angle) {
		...
		while (dx < dy) {
			...
			plotpoint(g, (int) ((x * Math.cos(rot) - y * Math.sin(-rot)) + xc),
					(int) ((x * Math.sin(-rot) + y * Math.cos(rot)) + yc));
			plotpoint(g, (int) (-(x * Math.cos(rot) - y * Math.sin(rot)) + xc),
					(int) ((x * Math.sin(rot) + y * Math.cos(rot)) + yc));
			plotpoint(g, (int) ((x * Math.cos(rot) - y * Math.sin(rot)) + xc),
					(int) (-(x * Math.sin(rot) + y * Math.cos(rot)) + yc));
	...
	void plottri(Graphics g, int base, int height, int xc, int yc, int angle) {
		...
		// plotline(xt1, yt1,xt2, yt1,g);
		// plotline(xt1, yt1,xc,yt2,g);
		// plotline(xt2, yt1,xc,yt2,g);
	...
	void plottri2(Graphics g, int base, int height, int xc, int yc, int angle) {
		...
		// plotline((xt1 + xc), (yt1 + yc),(xt2 + xc), (yt1 + yc),g);
		// plotline((xt1 + xc), (yt1 + yc),xc,(yt2 + yc),g);
		// plotline((xt2 + xc), (yt1 + yc),xc,(yt2 + yc),g);
		plotline((int) ((xt1 * Math.cos(rot) - yt1 * Math.sin(rot)) + xc),
				(int) ((xt1 * Math.sin(rot) + yt1 * Math.cos(rot)) + yc),
				(int) ((xt2 * Math.cos(rot) - yt1 * Math.sin(rot)) + xc),
				(int) ((xt2 * Math.sin(rot) + yt1 * Math.cos(rot)) + yc), g);
	...
	public void plotanimal(int xr, int feat[], Graphics g) {
		...
		/*
		 * if(hair == 1){
		 * plotline(20,25,(int)(Math.random()*5)+20,(int)(Math.random()*5)+25,g);
		 * plotline(12,38,(int)(Math.random()*5)+12,(int)(Math.random()*5)+38,g);
		 * plotline(24,30,(int)(Math.random()*5)+24,(int)(Math.random()*5)+30,g);
		 * plotline(10,30,(int)(Math.random()*5)+10,(int)(Math.random()*5)+30,g);
		 * plotline(28,21,(int)(Math.random()*5)+28,(int)(Math.random()*5)+21,g);
		 * plotline(12,21,(int)(Math.random()*5)+12,(int)(Math.random()*5)+21,g);
		 * plotline(28,15,(int)(Math.random()*5)+28,(int)(Math.random()*5)+15,g);
		 * plotline(15,15,(int)(Math.random()*5)+15,(int)(Math.random()*5)+15,g);
		 * }
		 */
	...
	public static void main(String[] args) {
		...
		JButton b9 = new JButton("Tri Ears");
